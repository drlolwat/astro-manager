                                   ...
                                   const QString &equalizerPresetId)
{
    ...
    return QStringLiteral(R"(# Generated by Astro Spatial. Manual changes will be overwritten.
context.properties = {
    log.level = 2
}
...
context.modules = [
    ...
    { name = libpipewire-module-filter-chain
        args = {
            node.description = "Astro Spatial %1"
            media.name = "Astro Spatial %1"
            filter.graph = {
                nodes = [
%2
                ]
...
%3
            ...
            playback.props = {
                ...
                node.description = "Astro Spatial to A50"
                node.passive = true
                target.object = %8
                audio.rate = 48000
                audio.channels = 2
